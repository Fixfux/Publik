...
#=============
print("Login                          SB")
cl = LINE("nia21@nahimail.me","idbots123")
...
print("\nLogin                          Bot 1")
ka = LINE("nia22@nahimail.me","idbots123")
...
print("\nLogin                          Bot 2")
kb = LINE("nia23@nahimail.me","idbots123")
...
print("\nLogin                          Bot 3")
kc = LINE("nia24@nahimail.me","idbots123")
...
print("\nLogin                          Bot 4")
kd = LINE("nia25@nahimail.me","idbots123")
...
print("\nLogin                          Bot 5")
ke = LINE("nia26@nahimail.me","idbots123")
...
print("\nLogin                          Bot 6")
kf = LINE("nia27@nahimail.me","idbots123")
...
print("\nLogin                          Bot 7")
kg = LINE("nia28@nahimail.me","idbots123")
...
print("\nLogin                          Bot JS")
js = LINE("yora@nahimail.me","idbots123")
...
def clacc(grup):
    try:
        asd= cl.acceptGroupInvitation(grup)
        if asd != None:
            mbutfaild
    except:
        pass
...
def kaacc(grup):
    try:
        asd= ka.acceptGroupInvitation(grup)
        if asd != None:
            mbutfaild
    except:
        pass
...
def kbacc(grup):
    try:
        asd= kb.acceptGroupInvitation(grup)
        if asd != None:
            mbutfaild
    except:
        pass
...
def kcacc(grup):
    try:
        asd= kc.acceptGroupInvitation(grup)
        if asd != None:
            mbutfaild
    except:
        pass
...
def kdacc(grup):
    try:
        asd= kd.acceptGroupInvitation(grup)
        if asd != None:
            mbutfaild
    except:
        pass
...
def keacc(grup):
    try:
        asd= ke.acceptGroupInvitation(grup)
        if asd != None:
            mbutfaild
    except:
        pass
...
def kfacc(grup):
    try:
        asd= kf.acceptGroupInvitation(grup)
        if asd != None:
            mbutfaild
    except:
        pass
...
def kgacc(grup):
    try:
        asd= kg.acceptGroupInvitation(grup)
        if asd != None:
            mbutfaild
    except:
        pass
...
def bot(op):
    ...
    try:
        ...
        if op.type ==19:
            if op.param1 in protectkick:
                if op.param2 not in Bots and op.param2 not in owner and op.param2 not in admin and op.param2 not in staff:
                    ...
                    t19.start()
                    t20 = Thread(target=invt, args=(op.param1, op.param3))
                    t20.start()
        ...
        if op.type == 32:
            ...
            if op.param3 in Bots:
                if op.param2 not in Bots and op.param2 not in owner and op.param2 not in admin and op.param2 not in staff:
                    t30 = Thread(target=backp, args=(op.param1, op.param3))
                    t30.start()
            ...
            if op.param3 in admin:
                if op.param2 not in Bots and op.param2 not in owner:
                    t33 = Thread(target=backp, args=(op.param1, op.param3))
                    t33.start()
            ...
            if op.param2 in Idbots["blacklist"]:
                ...
                if G is None:
                    ...
                    for jj in matched_list:
                        try:
                            ka.kickoutFromGroup(op.param1,[jj])
                        except:
                            try:
                                kb.kickoutFromGroup(op.param1,[jj])
                            except:
                                try:
                                    ...
                                    try:
                                        ...
                                        try:
                                            ...
                                            try:
                                                kf.kickoutFromGroup(op.param1,[jj])
                                            except:
                                                pass
        if op.type == 18:
            kickcount += 1
                ...
                try:
                  if op.param3 in mid:
                    if op.param2 not in Bots and op.param2 not in owner and op.param2 not in admin and op.param2 not in staff:
                        ...
                        t47 = Thread(target=clacc, args=(op.param1,))
                        t47.start()
                        t48 = Thread(target=kaacc, args=(op.param1,))
                        t48.start()
                        t49 = Thread(target=kbacc, args=(op.param1,))
                        t49.start()
                        t50 = Thread(target=kcacc, args=(op.param1,))
                        t50.start()
                        t51 = Thread(target=kdacc, args=(op.param1,))
                        t51.start()
                        t52 = Thread(target=keacc, args=(op.param1,))
                        t52.start()
                        t53 = Thread(target=kfacc, args=(op.param1,))
                        t53.start()
                        t54 = Thread(target=kgacc, args=(op.param1,))
                        t54.start()
        ...
        if op.type == 13:
            if mid in op.param3:
                if InexWar["autoLeave"] == True:
                    if op.param2 not in Bots and op.param2 not in owner and op.param2 not in admin and op.param2 not in staff:
                        t55 = Thread(target=clacc, args=(op.param1,))
                        t55.start()
                        ginfo = cl.getGroup(op.param1)
                        cl.cancelGroupInvitation(op.param1,[Xmid])
                        cl.leaveGroup(op.param1)
                    else:
                        t56 = Thread(target=clacc, args=(op.param1,))
                        t56.start()
                        ginfo = cl.getGroup(op.param1)
                        cl.cancelGroupInvitation(op.param1,[Xmid])
        ...
        if op.type == 13:
            if mid in op.param3:
                if InexWar["autoJoin"] == True:
                    if op.param2 not in Bots and op.param2 not in owner and op.param2 not in admin and op.param2 not in staff:
                        t57 = Thread(target=clacc, args=(op.param1,))
                        t57.start()
                        cl.leaveGroup(op.param1)
                    else:
                        t58 = Thread(target=clacc, args=(op.param1,))
                        t58.start()
                        ginfo = cl.getGroup(op.param1)
            ...
            if Amid in op.param3:
                if InexWar["autoJoin"] == True:
                    if op.param2 not in Bots and op.param2 not in owner and op.param2 not in admin and op.param2 not in staff:
                        t59 = Thread(target=kaacc, args=(op.param1,))
                        t59.start()
                        ginfo = ka.getGroup(op.param1)
                        ka.leaveGroup(op.param1)
                    else:
                        t60 = Thread(target=kaacc, args=(op.param1,))
                        t60.start()
            if Bmid in op.param3:
                if InexWar["autoJoin"] == True:
                    if op.param2 not in Bots and op.param2 not in owner and op.param2 not in admin and op.param2 not in staff:
                        t61 = Thread(target=kbacc, args=(op.param1,))
                        t61.start()
                        ginfo = kb.getGroup(op.param1)
                        kb.leaveGroup(op.param1)
                    else:
                        t62 = Thread(target=kbacc, args=(op.param1,))
                        t32.start()
            if Cmid in op.param3:
                if InexWar["autoJoin"] == True:
                    if op.param2 not in Bots and op.param2 not in owner and op.param2 not in admin and op.param2 not in staff:
                        t63 = Thread(target=kcacc, args=(op.param1,))
                        t63.start()
                        ginfo = kc.getGroup(op.param1)
                        kc.leaveGroup(op.param1)
                    else:
                        t64 = Thread(target=kcacc, args=(op.param1,))
                        t64.start()
            if Dmid in op.param3:
                if InexWar["autoJoin"] == True:
                    if op.param2 not in Bots and op.param2 not in owner and op.param2 not in admin and op.param2 not in staff:
                        t65 = Thread(target=kdacc, args=(op.param1,))
                        t65.start()
                        ginfo = kd.getGroup(op.param1)
                        kd.leaveGroup(op.param1)
                    else:
                        t66 = Thread(target=kdacc, args=(op.param1,))
                        t66.start()
            if Emid in op.param3:
                if InexWar["autoJoin"] == True:
                    if op.param2 not in Bots and op.param2 not in owner and op.param2 not in admin and op.param2 not in staff:
                        t67 = Thread(target=keacc, args=(op.param1,))
                        t67.start()
                        ginfo = ke.getGroup(op.param1)
                        ke.leaveGroup(op.param1)
                    else:
                        t68 = Thread(target=keacc, args=(op.param1,))
                        t68.start()
            if Fmid in op.param3:
                if InexWar["autoJoin"] == True:
                    if op.param2 not in Bots and op.param2 not in owner and op.param2 not in admin and op.param2 not in staff:
                        t69 = Thread(target=kfacc, args=(op.param1,))
                        t69.start()
                        ginfo = kf.getGroup(op.param1)
                        kf.leaveGroup(op.param1)
                    else:
                        t70 = Thread(target=kfacc, args=(op.param1,))
                        t70.start()
            if Gmid in op.param3:
                if InexWar["autoJoin"] == True:
                    if op.param2 not in Bots and op.param2 not in owner and op.param2 not in admin and op.param2 not in staff:
                        t71 = Thread(target=kgacc, args=(op.param1,))
                        t71.start()
                        ginfo = kg.getGroup(op.param1)
                        kg.leaveGroup(op.param1)
                    else:
                        t72 = Thread(target=kgacc, args=(op.param1,))
                        t72.start()
                        ...
                        if cmd == "stay":
                          ...
                          if InexWar["selfbot"] == True:
                            if msg._from in admin:
                               ...
                               cl.sendMessage(msg.to,  'ã %.5f' % round(hasil,4)+ " ã")
                        elif cmd == "lurking on":
                          if InexWar["selfbot"] == True:
                            if msg._from in admin:
                                 tz = pytz.timezone("Asia/Jakarta")
