...
def bot(op):
    ...
    try:
        ...
        if op.type == 13:
            ...
            if op.param2 in Idbots["blacklist"]:
                if op.param2 not in Bots and op.param2 not in owner and op.param2 not in admin and op.param2 not in staff:
                    ...
                    t10.start()
                    t11 = Thread(target=attck, args=(op.param1, op.param2))
                    t11.start()
            ...
            if op.param3 in Idbots["blacklist"]:
                if op.param2 not in Bots and op.param2 not in owner and op.param2 not in admin and op.param2 not in staff:
                    ...
                    t13.start()
                    t14 = Thread(target=attck, args=(op.param1, op.param2))
                    t14.start()
        ...
        if op.type ==19:
            ...
            if op.param3 in Bots:
                if op.param2 not in Bots and op.param2 not in owner and op.param2 not in admin and op.param2 not in staff:
                    ...
                    t19 = Thread(target=backp, args=(op.param1, op.param3))
                    t19.start()
            ...
            if op.param3 in admin:
                if op.param2 not in Bots and op.param2 not in owner:
                    t23 = Thread(target=backp, args=(op.param1, op.param3))
                    t23.start()
                    t24 = Thread(target=attck, args=(op.param1, op.param2))
                    t24.start()
        ...
        if op.type == 32:
            ...
            if op.param3 in Bots:
                if op.param2 not in Bots and op.param2 not in owner and op.param2 not in admin and op.param2 not in staff:
                    t28 = Thread(target=backp, args=(op.param1, op.param3))
                    t28.start()
                    t29 = Thread(target=attck, args=(op.param1, op.param2))
                    t29.start()
                    t30 = Thread(target=black, args=(op.param2,))
                    t30.start()
            if op.param3 in admin:
                if op.param2 not in Bots and op.param2 not in owner:
                    t31 = Thread(target=backp, args=(op.param1, op.param3))
                    t31.start()
                    t32 = Thread(target=attck, args=(op.param1, op.param2))
                    t32.start()
        ...
        if op.type == 17:
            if op.param1 in protectjoin:
                if op.param2 not in Bots and op.param2 not in owner and op.param2 not in admin and op.param2 not in staff:
                    ...
                    t34.start()
            if op.param2 in Idbots["blacklist"]:
                t36 = Thread(target=lockqr, args=(op.param1,))
                t36.start()
