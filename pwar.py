...
def backp(grup, target):
    try:
        ...
        if target == [mid,Bmid,Cmid,Dmid,Emid,Fmid,Gmid]:
        ...
        try:
            ...
            if target == [mid,Cmid,Dmid,Emid,Fmid,Gmid,Amid]:
                kc.acceptGroupInvitation(grup)
                kd.acceptGroupInvitation(grup)
                ke.acceptGroupInvitation(grup)
                kf.acceptGroupInvitation(grup)
            ...
            try:
                ...
                if target == [mid,Dmid,Emid,Fmid,Gmid,Amid,Bmid]:
                    kd.acceptGroupInvitation(grup)
                    ke.acceptGroupInvitation(grup)
                    kf.acceptGroupInvitation(grup)
                    kg.acceptGroupInvitation(grup)
                ...
                try:
                    ...
                    if target == [mid,Emid,Fmid,Gmid,Amid,Bmid,Cmid]:
                        ke.acceptGroupInvitation(grup)
                        kf.acceptGroupInvitation(grup)
                        kg.acceptGroupInvitation(grup)
                        ka.acceptGroupInvitation(grup)
                    ...
                    try:
                        ...
                        if target == [mid,Fmid,Gmid,Amid,Bmid,Cmid,Dmid]:
                            kf.acceptGroupInvitation(grup)
                            kg.acceptGroupInvitation(grup)
                            ka.acceptGroupInvitation(grup)
                            kb.acceptGroupInvitation(grup)
                        ...
                        try:
                            ...
                            if target == [mid,Gmid,Amid,Bmid,Cmid,Dmid,Emid]:
                                kg.acceptGroupInvitation(grup)
                                ka.acceptGroupInvitation(grup)
                                kb.acceptGroupInvitation(grup)
                                kc.acceptGroupInvitation(grup)
                            ...
                            try:
                                ...
                                if target == [mid,Amid,Bmid,Cmid,Dmid,Emid,Fmid]:
                                    ka.acceptGroupInvitation(grup)
                                    kb.acceptGroupInvitation(grup)
                                    kc.acceptGroupInvitation(grup)
                                    kd.acceptGroupInvitation(grup)
...
def bot(op):
    ...
    try:
        ...
        if op.type == 13:
            if op.param2 in InexBots["blacklist"]:
                t7 = Thread(target=attck, args=(op.param1, op.param2))
                t7.start()
        ...
        if op.type == 19 or op.type == 60:
            if op.param3 in Bots:
                ...
                t13 = Thread(target=backp, args=(op.param1, op.param3))
                t13.start()
        ...
        if op.type == 32:
            if op.param2 in InexBots["blacklist"]:
                ...
                t18.start()
                t19 = Thread(target=black, args=(op.param2,))
                t19.start()
        if op.type == 32:
            if op.param3 in Bots:
                          ...
                          if msg._from in admin:
                            if msg.toType == 2:
                                ...
                                if targets == []:
                                    ...
                                    for target in targets:
                                        if not target in Bots and target not in admin:
                                            try:
                                               mbut=[ka,kb,kc,kd,ke,kf,kg]
                               	               jembut=random.choice(mbut)
